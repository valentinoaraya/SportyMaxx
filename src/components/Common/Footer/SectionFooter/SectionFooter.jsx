                ...
                <h4 className='titleFooterSection'>{titleSection2}</h4>
                {
                    arraySubtitles2.map((element) => {
                        if (titleSection2 !== "MEDIOS DE ENVÍO") {
                            if (titleSection2 === "REDES SOCIALES"){
                                return <a key={element} className='linkFooter' href="https://www.instagram.com/sporting.maxx/" target={"_blank"} rel="noopener noreferrer">
